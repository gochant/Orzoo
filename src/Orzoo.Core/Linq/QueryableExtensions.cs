...
namespace Orzoo.Core.Linq
{
    public static class QueryableExtensions
    {
        ...
        public static IEnumerable<KendoGroupResult<TKey, TElement>> ToKendoGroupResult<TKey, TElement>(this IEnumerable<IGrouping<TKey, TElement>> list)
        {
            return list.Select(d => new KendoGroupResult<TKey, TElement>
            {
                value = d.Key,
                items = d
            });
