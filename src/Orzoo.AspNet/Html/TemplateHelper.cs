...
namespace Orzoo.AspNet.Html
{
    public class TemplateHelper
    {
        ...
        static TemplateHelper()
        {
            ...
            {
                throw new Exception(
                    "An error occured while attempting to access the PropertyInfo for the VisitedObjects property of type System.Web.Mvc.TemplateInfo. This might be happening because you're using a different version of ASP.Net MVC",
                    exception);
            }
        }
